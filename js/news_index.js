$(function() {
  var index = 0;
  var pictureWidth = $(".news_box_picture li").width();
  var picturelength = $(".news_box_picture li").length;
  $(window).resize(function() {
    Width = $(".news_box_picture").width();
    $(".news_box_picture li").width(Width);
    pictureWidth = $(".news_box_picture li").width();
    picturelength = $(".news_box_picture li").length;
    picWidth = pictureWidth * picturelength;
    $(".news_box_picture ul").css("width", picWidth + "px");
    index = 0;
    i = 0;
    $(".news_box_picture ul").css("left", "0px");
    $(".news_box_pic_circle li img").attr("src", "images/circle1.png");
    $(".news_box_pic_circle li img").eq(i).attr("src", "images/circle2.png");
  });

  var m = 0;
  $(".news_box_pic_circle li").click(function() {
    var y = $(".news_box_pic_circle li").index(this);
    index = y;
    i = y;
    $(".news_box_picture ul").stop(true, false).animate({
  ...
  function picMove_1() {
    ...
    time1 = setTimeout(picMove_1, 5000);
  }
  setTimeout(picMove_1, 1000);
  var i = 0;
  function spotMove() {
    i++;
    if (i == 4) {
    ...
    $(".news_box_pic_circle li img").attr("src", "images/circle1.png");
    $(".news_box_pic_circle li img").eq(i).attr("src", "images/circle2.png");
    setTimeout(spotMove,5000);
  }
setTimeout(spotMove, 1000);
});
